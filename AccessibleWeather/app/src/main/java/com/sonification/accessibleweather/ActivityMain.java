...
public class ActivityMain extends FragmentActivity
{
    ...
    private boolean internetConnection() {
		 ...
		 */
        ConnectivityManager connectivityManager = (ConnectivityManager)ActivityMain.this.getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    private void citySelected(String lat, String lon)
    {
        ...
        if (internetConnection()) {
            ...
            Toast.makeText(ActivityMain.this, getResources().getText(R.string.noInternetString), Toast.LENGTH_LONG).show();
        }
